...
class FunctionMSTModel {
  ...
  factory FunctionMSTModel.fromJson(Map<String, dynamic> json) => FunctionMSTModel(
    ...
    refID: json["refid"],
    myBusID: json["mybusid"],
    lableFlag: json["lableflag"],
    sp1: json["sP1"],
    sp2: json["sP2"],
    sp3: json["sP3"],
    sp4: json["sP4"],
...
factory FunctionMSTModel.fromMap(Map<String, dynamic> map) =>
      FunctionMSTModel(
        ...
        commanLine: map[Constants.commanLine],
        activeFlage: map[Constants.activeFLAG],
        metaTitle: map[Constants.metaTitle],
        metaKeyword: map[Constants.metaKeyWord],
        metaDescription: map[Constants.metaDescription],
        headerVisibleData: map[Constants.headerVisibleData],
        headerInvisibleData: map[Constants.headerInVisibleData],
        footerVisibleData: map[Constants.footerVisibleData],
        footerInvisibleData: map[Constants.footerInVisibleData],
        refID: map[Constants.refID],
        myBusID: map[Constants.myBusID],
        lableFlag: map[Constants.lableFlag],
        ...
        activeMenu: map[Constants.activeMenu],
        menuDate: map[Constants.menuDate],
      );
